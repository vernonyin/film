    ...
    <body>
        <nav class="navbar navbar-default" role="navigation">
            <div class="navbar-header">
                <a class="navbar-brand" href="#">价格查询--<span style="font-size:50%;">再也不用挨个app点开比较电影票价格了</span></a>
            </div>
        </nav>
        <div class="dropdown">
            ...
            <ul id="area_list" class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                ...
                <li><a href="#">宝安区</a></li>  <li class="divider"></li> <li><a href="#">福田区</a></li><li class="divider"></li>
                <li><a href="#">龙岗区</a></li>  <li class="divider"></li> <li><a href="#">盐田区</a></li><li class="divider"></li>
                <li><a href="#">其他区县</a></li>
            </ul>
        </div>
        <div class="dropdown">
        ...
        <div id="data_div" >
            ...
            <div id="aa" >
                <br/>
                <img src="./img/qrcode.jpg" width=80% />
            长按二维码关注收藏
        </div>
...
//                    $("#grab").html("3.抓取");
                ...
                $('#see_now').click(function () {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/film/get_film_list.php?cid=" +  $('#dropdownMenu2').attr("value"),
